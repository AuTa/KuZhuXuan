            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        this.registerInterval(window.setInterval(function () { return _this.refreshStatusBar(); }, 1000));
                                    ...
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.getFilesChanged().then(function (files) { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            if (!!files.length) return [3 /*break*/, 1];
                                                        ...
                                                        case 1: return [4 /*yield*/, this.add()
                                                                ...
                                                                .then(function () {
                                                                return _this.displayMessage("Pushed " + files.length + " files");
                                                            })];
                                                        case 2:
                                                            _a.sent();
                                                            _a.label = 3;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        numFiles = statusResult.files.length;
    ...
    StatusBar.prototype.displayMessage = function (message, timeout) {
        ...
        if (timeout && timeout > 0) {
            window.setTimeout(function () {
                _this.isDisplayingMessage = false;
            }, timeout);
        }
    };
    StatusBar.prototype.displayState = function (state, lastUpdate) {
